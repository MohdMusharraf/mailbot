...
const labelName = "mailBotReplied";
              ...
              requestBody: {
                raw: Buffer.from(
                  `To: ${
                    ...
                    `I appreciate your email and I hope this correspondence finds you in good spirits. I wanted to inform you that I am currently away from the office, enjoying a well-deserved vacation. As a result, my access to email will be limited, and I may not be able to provide immediate responses during this time. Rest assured, I will make every effort to check my inbox periodically, but there may be delays in my replies.\r\n`
                ).toString("base64"),
              },
            };
